...
export default function NavBar(props) {
    ...
    return (
        <>
            ...
            <div className={(isScrolledDown && props.postTitle ? "flex" : "hidden") + " top-0 sticky flex-wrap w-screen h-auto bg-white shadow items-center justify-center md:justify-between font-mono z-50 px-4"}>
                <div className="flex h-full font-semibold items-center text-gray-800 text-sm whitespace-nowrap overflow-scroll my-3">
                    <img className="h-5 mr-2" src="https://hackernoon.com/hn-icon.png" />
                    {props.postTitle} by <a href="#" className="ml-2 font-bold bg-limegreen-100 hover:border-0 hover:border-brand hover:bg-brand">@{props.postAuthor}</a>
                </div>
                <div className="flex flex-row text-limegreen-600 space-x-4 my-3 items-center">
            ...
            <div className={(isScrolledDown ? "hidden" : "flex") + " sticky top-0 flex-col w-screen"}>
